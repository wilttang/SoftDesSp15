...
def remap_interval(val, input_interval_start, input_interval_end, output_interval_start, output_interval_end):
    ...
    """
    val = val + .0
    end_length = output_interval_end - output_interval_start + .0
    start_length = input_interval_end - input_interval_start + .0
    val_percentage = (val - input_interval_start) / start_length
    output = (output_interval_start + val_percentage * end_length) + .0
    return output
    #TODO: implement this
    pass
